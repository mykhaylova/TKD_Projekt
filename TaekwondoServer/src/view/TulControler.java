...
public class TulControler {
	...
	@FXML private Button startButtonTul;
	@FXML private Button stopButtonTul;
	@FXML private Button backButtonTul;
	@FXML private Button resetButtonTul;
	@FXML private Button exitButtonTul;

	@FXML private Label topLeftLabelTul;
	@FXML private Label topRightLabelTul;
	@FXML private Label middleLeftLabelTul;
	@FXML private Label middleRightLabelTul;
	@FXML private Label bottomLeftLabelTul;
	@FXML private Label bottomRightLabelTul;
	...
	private void handleBackButtonAction (ActionEvent e) throws IOException {
		...
		Stage stage = (Stage) backButtonTul.getScene().getWindow();
        stage.close();
